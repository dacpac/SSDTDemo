EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'AdventureWorks2008R2 Sample OLTP Database';
...
GO
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = N'Primary filegroup for the AdventureWorks2008R2 sample database.', @level0type = N'FILEGROUP', @level0name = N'PRIMARY';
